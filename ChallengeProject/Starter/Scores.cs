...
namespace Starter
{
    class Scores
    {
        public static int examAssignments = 5;

        public static string[] studentNames = new string[] { "Sophia", "Andrew", "Emma", "Logan" };

        public static int[] sophiaScores = new int[] { 90, 86, 87, 98, 100, 94, 90 };
        public static int[] andrewScores = new int[] { 92, 89, 81, 96, 90, 89 };
        public static int[] emmaScores = new int[] { 90, 85, 87, 98, 68, 89, 89, 89 };
        public static int[] loganScores = new int[] { 90, 95, 87, 88, 96, 96 };

        public static int[] studentScores = new int[10];

        public static string currentStudentLetterGrade = "";
